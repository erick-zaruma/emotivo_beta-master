...
public class PeriodListFragment extends Fragment {
    ...
    public PeriodListFragment(String pathName) {
    ...
    private String getButtonName(int buttonNumber) {
        String name = "Epoch " + Integer.toString(buttonNumber);
        //pull from db
        return name;
    }

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_authoring_period_list, container, false);
        if (view == null) {
            return null;
        }
        ...
        new TutorialShiba(getContext(), layout, new ArrayList<>(Arrays.asList("This is where you will write about" +
                "your past experiences. We will divide your past writing into 6 epochs, think of these as chapters.",
                "You can name each epoch after a significant event. Try to think of events that bring up strong emotions" +
                        "today.")));
        return view;
    }
}
